...
var francis = User(name: "Francis", age: 18, height: 68, weight: 145, activityLevel: 6)
print("My name is \(francis.name). I am \(francis.age), weigh \(francis.weight) lbs and am \(francis.height) inches tall. On an activity scale from 1-10 I am probably a \(francis.activityLevel).")
